...
public class GuestbookServiceTests {
    ...
    public void testList() {
        ...
        System.out.println("PREV: " + resultDTO.isPrev() + " //이전으로 가는 링크 필요 여부");
        System.out.println("NEXT: " + resultDTO.isNext() + " //다음 페이지로 가능 링크 필요 여부");
    ...
    public void testSearch() {
        ...
        for (Integer dto : resultDTO.getPageList()) {
